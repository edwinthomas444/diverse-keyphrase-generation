...
class BertForTokenClassification(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # adding class weights to the optimizer
        class_weight = torch.FloatTensor(
            [1.0, 5.0, 5.0, 5.0]).cuda()
    ...
    def forward(
        ...
        if labels is not None:
            ...
            # normalize and also add class weights
            loss = self.loss_mask_and_normalize(loss.float(), attention_mask)
